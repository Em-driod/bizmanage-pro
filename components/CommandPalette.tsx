    ...
    try {
      ...
      if (parsed.intent === 'LOG_TRANSACTION' && parsed.data) {
        ...
        setCommand(''); // clear the input so they can ask another question
          ...
          setResult({ success: false, message: 'Morniy Intelligence could not process the format.' });
      }
        ...
        <div className="relative z-10 flex-shrink-0">
          <form onSubmit={handleSubmit} className="relative flex items-center px-6 h-20 border-b border-white/10 bg-white/[0.02]">
            ...
            <input
              ...
              placeholder="Ask Morniy anything, or log a transaction..."
              value={command}
            ...
            result.isQuery ? (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/10">
                   ...
                   <div>
                     <p className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Morniy Intelligence</p>
